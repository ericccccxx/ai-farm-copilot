...
- V0.7: image intake checklist and photo comparison workflow.
- V0.8: camera and drone photo batch workflow.
- V0.9: ESP32/Raspberry Pi sensor JSON adapter.
- V0.10: NDVI and map-based scouting notes.
